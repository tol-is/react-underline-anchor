    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <p>
          ...
          <AnchorUnderline href="#">abstract speed</AnchorUnderline> prop, that configures the relative velocity of the transition. Using
          CSS custom properies you can further customize the underline{' '}
          <AnchorUnderline href="#" style={{ '--underline-color': '#00ffcc', '--underline-size': '2px' } as React.CSSProperties}>
            color
          </AnchorUnderline>
          ,{' '}
          ...
          ,{' '}
          <AnchorUnderline href="#" style={{ '--underline-position-y': '60%' } as React.CSSProperties}>
            position
          </AnchorUnderline>
          ,{' '}
          <AnchorUnderline
        ...
        <p>
          ...
          <AnchorUnderline href="#">
            measuring the length of its text contents, and dynamically computes the animation duration,
          </AnchorUnderline>{' '}
          so the transition feels <AnchorUnderline href="#">consistent across applications</AnchorUnderline>, within paragraphs, or
